...
# Principles of Evolution - Variation

Individuals within populations have slightly different traits (some are faster, some are a different color).

```

    traits TraitS tr4its tRait5

    traIT5 traits TRAIts tRaits

    trait5 tr4Its TRaitS traIts

    TrAitS tRaits tRaIts tr4its

```

---

# Principles of Evolution - Inheritance
...
# Principles of Evolution - Selection / Time
...
# The Peppered Moth - Genetic Algorithm
...
# The Peppered Moth - Generation 1
...
# The Peppered Moth - Generation 16
...
# The Peppered Moth - Generation 128
...
Subset of genetic programming where computer programs are represented as a linear sequence of instructions.
...
# Optimizing Evolvability - Traditional 
...
# Optimizing Evolvability - Finches
